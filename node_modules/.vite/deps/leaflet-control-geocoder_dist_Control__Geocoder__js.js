...
var leafletControlGeocoder = function(exports, L2) {
  ...
  var L__namespace = _interopNamespace(L2);
      ...
      getJSON(this.options.serviceUrl + "/findAddressCandidates", params, function(data) {
        ...
        if (data.candidates && data.candidates.length) {
          for (var i = 0; i <= data.candidates.length - 1; i++) {
            ...
            var latLng2 = L__namespace.latLng(loc.location.y, loc.location.x);
  ...
  var Bing = function() {
    function Bing2(options) {
      this.options = {
        serviceUrl: "https://dev.virtualearth.net/REST/v1/Locations"
      };
      L__namespace.Util.setOptions(this, options);
    }
    var _proto = Bing2.prototype;
    _proto.geocode = function geocode(query, cb, context) {
      var params = geocodingParams(this.options, {
        query,
  ...
  var Google = function() {
    function Google2(options) {
      this.options = {
        serviceUrl: "https://maps.googleapis.com/maps/api/geocode/json"
      };
      L__namespace.Util.setOptions(this, options);
    }
    var _proto = Google2.prototype;
    _proto.geocode = function geocode(query, cb, context) {
      var params = geocodingParams(this.options, {
        key: this.options.apiKey,
        address: query
      ...
      getJSON(this.options.serviceUrl, params, function(data) {
        ...
        if (data.results && data.results.length) {
          for (var i = 0; i <= data.results.length - 1; i++) {
            ...
            var latLng2 = L__namespace.latLng(loc.geometry.location);
      ...
      getJSON(url, params, function(data) {
        ...
        if (data.items && data.items.length) {
          for (var i = 0; i <= data.items.length - 1; i++) {
            ...
            var latLng2 = L__namespace.latLng(item.position.lat, item.position.lng);
            var bbox = void 0;
            if (item.mapView) {
  ...
  var Mapbox = function() {
    function Mapbox2(options) {
      this.options = {
        serviceUrl: "https://api.mapbox.com/geocoding/v5/mapbox.places/"
      };
      L__namespace.Util.setOptions(this, options);
    }
    var _proto = Mapbox2.prototype;
  ...
  var MapQuest = function() {
    ...
    var _proto = MapQuest2.prototype;
  ...
  var Neutrino = function() {
    ...
    var _proto = Neutrino2.prototype;
    _proto.geocode = function geocode(query, cb, context) {
      var params = geocodingParams(this.options, {
        apiKey: this.options.apiKey,
  ...
  var Nominatim = function() {
    ...
    var _proto = Nominatim2.prototype;
    _proto.geocode = function geocode(query, cb, context) {
      var _this = this;
      var params = geocodingParams(this.options, {
        q: query,
      ...
      getJSON(this.options.serviceUrl + "search", params, function(data) {
        ...
        for (var i = data.length - 1; i >= 0; i--) {
          ...
          results[i] = {
            ...
            html: _this.options.htmlTemplate ? _this.options.htmlTemplate(data[i]) : void 0,
      ...
      getJSON(this.options.serviceUrl + "reverse", params, function(data) {
        ...
        if (data && data.lat && data.lon) {
          ...
          result.push({
            ...
            html: _this2.options.htmlTemplate ? _this2.options.htmlTemplate(data) : void 0,
            center,
            bbox,
            properties: data
          });
  ...
  var OpenLocationCode = function() {
    function OpenLocationCode2(options) {
      L__namespace.Util.setOptions(this, options);
    }
    var _proto = OpenLocationCode2.prototype;
    _proto.geocode = function geocode(query, cb, context) {
      try {
    ...
    return OpenLocationCode2;
  }();
  function openLocationCode(options) {
    return new OpenLocationCode(options);
  }
  var OpenCage = function() {
    function OpenCage2(options) {
      this.options = {
        serviceUrl: "https://api.opencagedata.com/geocode/v1/json"
      };
      L__namespace.Util.setOptions(this, options);
    }
    var _proto = OpenCage2.prototype;
    _proto.geocode = function geocode(query, cb, context) {
      var params = geocodingParams(this.options, {
        key: this.options.apiKey,
        q: query
  ...
  var Mapzen = Pelias;
  var mapzen = pelias;
  var Openrouteservice = function(_Pelias) {
    _inheritsLoose(Openrouteservice2, _Pelias);
    function Openrouteservice2(options) {
      return _Pelias.call(this, L__namespace.Util.extend({
        serviceUrl: "https://api.openrouteservice.org/geocode"
      }, options)) || this;
    }
    return Openrouteservice2;
  }(Pelias);
  function openrouteservice(options) {
    return new Openrouteservice(options);
  }
  var Photon = function() {
    function Photon2(options) {
      this.options = {
    ...
    _proto.reverse = function reverse(latLng2, scale, cb, context) {
      var params = reverseParams(this.options, {
        lat: latLng2.lat,
        lon: latLng2.lng
      });
  ...
  var What3Words = function() {
    function What3Words2(options) {
      this.options = {
        serviceUrl: "https://api.what3words.com/v2/"
      };
      L__namespace.Util.setOptions(this, options);
    }
    var _proto = What3Words2.prototype;
    _proto.geocode = function geocode(query, cb, context) {
      getJSON(this.options.serviceUrl + "forward", geocodingParams(this.options, {
        ...
        var results = [];
        if (data.geometry) {
          var latLng2 = L__namespace.latLng(data.geometry["lat"], data.geometry["lng"]);
          var latLngBounds = L__namespace.latLngBounds(latLng2, latLng2);
          results[0] = {
            name: data.words,
            bbox: latLngBounds,
            center: latLng2
  ...
  var GeocoderControl = function(_EventedControl) {
    _inheritsLoose(GeocoderControl2, _EventedControl);
    function GeocoderControl2(options) {
      var _this;
    ...
    var _proto = GeocoderControl2.prototype;
    ...
    _proto._createAlt = function _createAlt(result, index) {
      var _this4 = this;
      var li = L__namespace.DomUtil.create("li", ""), a = L__namespace.DomUtil.create("a", "", li), icon = this.options.showResultIcons && result.icon ? L__namespace.DomUtil.create("img", "", a) : null, text = result.html ? void 0 : document.createTextNode(result.name), mouseDownHandler = function mouseDownHandler2(e) {
    ...
    _proto._keydown = function _keydown(e) {
      var _this5 = this;
      var select = function select2(dir) {
...
leaflet-control-geocoder/dist/Control.Geocoder.js:
   ...
   *)
*/
//# sourceMappingURL=leaflet-control-geocoder_dist_Control__Geocoder__js.js.map
